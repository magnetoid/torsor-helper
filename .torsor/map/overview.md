...
- **src/torsor_helper/guard.py** — 12 symbol(s)
...
- **src/torsor_helper/hooks.py** — 14 symbol(s)
  ...
  - `claude_edit_command(root: str)` (function)
...
- **src/torsor_helper/languages/javascript.py** — 20 symbol(s)
  ...
  - `_is_class_member(node)` (function)
  - `_doc_anchor(node)` (function)
- **src/torsor_helper/languages/modules.py** — 2 symbol(s)
  - `norm_module(module: str)` (function)
  - `strip_suffix(module: str)` (function)
- **src/torsor_helper/languages/python.py** — 9 symbol(s)
  - `_first_line(text: str | None)` (function)
  - `_signature(fn: ast.FunctionDef | ast.AsyncFunctionDef)` (function)
  - `extract_symbols(source: str, module: str)` (function)
  - `absolute_from_module(node: ast.ImportFrom, module: str)` (function)
  - `_import_aliases(tree: ast.Module, module: str)` (function)
- **src/torsor_helper/languages/treesitter.py** — 11 symbol(s)
  - `text(node)` (function)
  -…[truncated]
