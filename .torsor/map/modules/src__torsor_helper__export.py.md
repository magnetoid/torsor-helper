...
Symbols in `src/torsor_helper/export.py`.

- L12 `_summary(body: str)` (function) — First non-empty, non-heading prose line (underscores stripped) — used as
- L22 `_rel(path, paths)` (function)
