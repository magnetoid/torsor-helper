...
Symbols in `src/torsor_helper/languages/go.py`.

- L28 `_params(node)` (function)
- L33 `extract_symbols(source: str, module: str)` (function)
- L52 `imports(source: str, module: str='')` (function)
- L57 `_owner(node)` (function)
- L69 `_walk(node)` (function)
